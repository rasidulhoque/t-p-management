...
export const JobDrivesStudent = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/auth/jobDrivesStudent`)
      .then((response) => {
  ...
  const handleApply = () => {
    axios
      .post(`http://localhost:4000/auth/appliedJobs`, {
        username,
        job_id,
        department,
      })
  ...
  return (
    <>
      ...
      <Dialog>
        ...
        <DialogActions>
          <Button onClick={handleApply}>Done</Button>
