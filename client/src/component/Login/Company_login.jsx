...
import { CompanyNameContext } from "../StudentProfile/contexts/StepperContext";
...
export const Company_login = () => {
  ...
  const { setCompanyName } = useContext(CompanyNameContext);
  const { setCompanyAddress } = useContext(CompanyAddressContext);
  const { setId } = useContext(CompanyIdContext);
  const { setLogo } = useContext(CompanyLogoContext);
  ...
  const login = (val) => {
    axios
      .post(`http://localhost:4000/auth/company_login`, {
        ...val,
      })
      .then((res) => {
        console.log(res.data.username);
        console.log(res.data.company_name, "company name");
        console.log(res.data.company_address, "grt");
