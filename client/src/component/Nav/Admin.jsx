...
import { Admin_dash } from "../AdminInterface/Admin_dash";
...
export default function Admin() {
  ...
  console.log(photo, "profile pic admin");
        ...
        >
          ...
          >
            ...
            <Link to="/Add_admin">
              <ListItem sx={{ gap: 2, p: 3 }}>
                <PersonAddIcon />
                <Typography variant="p">Add TPO</Typography>
              </ListItem>
            </Link>
            <Link to="/Departments">
              <ListItem sx={{ gap: 2, p: 3 }}>
                <ClassIcon />
                <Typography variant="p">Departments</Typography>
              </ListItem>
            </Link>
            {/* <Link to="/ManageHomepage">
              <ListItem sx={{ gap: 2, p: 3 }}>
                <DisplaySettingsIcon />
                <Typography variant="p">Manage Homepage</Typography>
              </ListItem>
            </Link> */}
            <Link to="/Approve_Student">
              <ListItem sx={{ gap: 2, p: 3 }}>
                <Badge color="error" badgeContent={studentCount} showZero>
                  <Man4Icon />
                </Badge>
                <Typography variant="p">Manage Registered Student</Typography>
              </ListItem>
            </Link>
            <Link to="/Approve_Company">
              <ListItem sx={{ gap: 2, p: 3 }}>
                <Badge color="error" badgeContent={companyCount} showZero>
                  <AddBusinessIcon />
                </Badge>
                <Typography variant="p">Manage Registered Company</Typography>
              </ListItem>
            </Link>
            <Link to="/EventList">
              <ListItem sx={{ gap: 2, p: 3 }}>
                <FeedIcon />
                <Typography variant="p">Add News & Events</Typography>
              </ListItem>
            </Link>
          </List>
        </Drawer>
